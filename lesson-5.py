...
# print(f"Today is friday {day}. Happy birthday, {name} You are {len(name)} years old!")
# print(f"Today is friday {day:25}. Happy birthday, {name} You are {len(name)} years old!")
# print(f"Today is friday {day:7d}.")
# print(f"Today is friday {name:7s}.")
